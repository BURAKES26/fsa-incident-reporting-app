...
val MaterialSymbolsQueryStats: ImageVector
    get() {
        if (_MaterialSymbolsQueryStats != null) return _MaterialSymbolsQueryStats!!

        _MaterialSymbolsQueryStats = ImageVector.Builder(
            name = "query_stats",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
        ...
        return _MaterialSymbolsQueryStats!!
    }

private var _MaterialSymbolsQueryStats: ImageVector? = null